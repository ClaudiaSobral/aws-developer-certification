...
A base do meu estudo será o [AWS Developer Learning Plan (português)](https://skillbuilder.aws/learning-plan/8ZTS6X8W2U/aws-developer-learning-plan-portugus/BGT389JBTZ), disponível no AWS SkillBuilder. Além disso, sou apoiada pela [Escola da Nuvem](https://escoladanuvem.org/), que fornece aulas, apostila e um voucher de 100% na trilha de extensão Developer.
